...
export const fetchFriendData = () => {
  return (dispatch) => {
    ...
    axios
      .get("http://localhost:8000/getConnectedFriends", {
        headers: {
    ...
    dispatch(fetchFriendStart());
    axios
      .get("http://localhost:8000/getReceivedFriendCount", {
        headers: {
          authorization: Cookies.get("token"),
        },
      })
...
export const fetchSuggesstedFriendData = () => {
  return (dispatch) => {
    dispatch(fetchFriendStart());
    axios
      .get("http://localhost:8000/getSuggesstions", {
        headers: {
...
export const onConfirmFriendHandler = (friendId) => {
  ...
  return (dispatch) => {
    axios
      .post(
        "http://localhost:8000/confirmFriend",
        { friendId: friendId },
        {
          headers: {
            "Content-Type": "application/json",
...
export const onRejectFriendHandler = (friendId) => {
  ...
  return (dispatch) => {
    axios
      .post(
        "http://localhost:8000/rejectFriend",
        { friendId: friendId },
        {
          headers: {
            "Content-Type": "application/json",
